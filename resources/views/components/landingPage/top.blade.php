        ...
        <div class="main">
            <div class="mt-10 md:mt-16 lg:flex lg:space-x-5">
                ...
                <div
                    ...
                    <a href="/news/{{ $top[0]->slug }}?callbackUrl={{ urlencode(url()->full()) }}">
                        <img src="/uploads/news/{{ $top[0]->image }}" loading="lazy" alt={{ $top[0]->title }}
                    ...
                    <div class="md:w-full">
                        <h1
                            ...
                            <a href="/news/{{ $top[0]->slug }}?callbackUrl={{ urlencode(url()->full()) }}"
                                class="hover:text-secondary-yellow"><span class="text-gray-700">#Top 1
                                    : </span>{{ $top[0]->title }}</a>
                        </h1>
                ...
                <div class="flex flex-col lg:w-1/2">
                    ...
                    <div
                        ...
                        <a href="/news/{{ $top[1]->slug }}?callbackUrl={{ urlencode(url()->full()) }}">
                            <img src="/uploads/news/{{ $top[1]->image }}" loading="lazy" alt={{ $top[1]->title }}
                        ...
                        <div class="md:w-full">
                            <h1
                                class="mt-1 text-lg font-bold leading-5 text-primary font-montserrat md:text-xl lg:text-2xl">
                                <a href="/news/{{ $top[1]->slug }}?callbackUrl={{ urlencode(url()->full()) }}"
                                    class="hover:text-secondary-yellow"><span class="text-gray-700">#Top 2
                                        : </span>{{ $top[1]->title }}</a>
                            </h1>
                            <p class="mt-3 text-sm font-light md:mt-5 md:text-base">
                    ...
                    <div
                        ...
                        <a href="/news/{{ $top[2]->slug }}?callbackUrl={{ urlencode(url()->full()) }}"
                            class="inline-block w-full h-full lg:me-5">
                            <img src="/uploads/news/{{ $top[2]->image }}" loading="lazy" alt={{ $top[2]->title }}
                        ...
                        <div class="w-2/3">
                            <h1 class="mt-1 text-lg font-bold leading-5 text-primary font-montserrat lg:text-2xl">
                                <a href="/news/{{ $top[2]->slug }}?callbackUrl={{ urlencode(url()->full()) }}"
                                    class="hover:text-secondary-yellow"><span class="text-gray-700">#Top 3
                                        : </span>{{ $top[2]->title }}</a>
                            </h1>
