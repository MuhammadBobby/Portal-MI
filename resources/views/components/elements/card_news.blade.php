...
<div
    class="bg-white border border-gray-200 rounded-lg shadow  min-w-[80%] md:min-w-[30%] -z-0 hover:bg-gray-100 flex flex-col justify-between">
    <div>
        <a href={{ $item->slug }}>
        ...
        <div class="p-5">
            <div class="mb-3">
                ...
                <span
                    class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded">{{ $item->category->name }}</span>
            </div>
            <a href={{ $item->slug }}>
